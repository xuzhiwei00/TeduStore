...
<div class="lf1">
    <div class="lf1_top">
        ...
        <div class="left lf">
            <div class="left_pro lf">
                ...
                <p class="top_ys4 color_2"><a href="${pageContext.request.contextPath}/goods/goodsInfo.do?id=${goods.id}&categoryId=${goods.categoryId}">查看详情</a></p>
            </div>
    ...
    <div class="lf1_bottom">
        ...
        <div class="item_msg lf">
            ...
            <p class="bottom_ys4 color_2"><a href="${pageContext.request.contextPath}/goods/goodsInfo.do?id=${goods.id}&categoryId=${goods.categoryId}">查看详情</a></p>
        </div>
        </c:forEach>
    </div>
</div>
...
<div class="lf1">
    <div class="lf1_top">
        ...
        <div class="left lf">
            ...
            <div class="left_pro lf">
                ...
                <p class="top_ys4 color_1"><a href="${pageContext.request.contextPath}/goods/goodsInfo.do?id=${goods.id}&categoryId=${goods.categoryId}">查看详情</a></p>
            </div>
        </div>
        <!-- 上面部分右侧区域-->
        <div class="right lf">
    ...
    <div class="lf1_bottom">
        ...
        <div class="item_msg lf">
            ...
            <p class="bottom_ys4 color_1"><a href="${pageContext.request.contextPath}/goods/goodsInfo.do?id=${goods.id}&categoryId=${goods.categoryId}">查看详情</a></p>
        </div>
        <div class="item_msg lf">
        ...
        <div class="item_msg lf">
            ...
            <p class="bottom_ys4 color_1"><a href="${pageContext.request.contextPath}/goods/goodsInfo.do?id=${goods.id}&categoryId=${goods.categoryId}" id="iii">查看详情</a></p>
            </a>
        </div>
