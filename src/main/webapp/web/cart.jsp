...
<div class="big">
                ...
                <div class="imfor">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id="${cartvo.id } ">
                            <img src="..${cartvo.image}" class="lf" width="84px" height="84px"/>
                            <input type="hidden" name="" value="">
                        <span class="des lf">
                            ${cartvo.title}
                              <input type="hidden" name="" value="">
                    ...
                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value="${cartvo.count}" ><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
    ...
    <div class="none" style="display: none">
        ...
        <div class="none_content">
            ...
            <a href="../show/index.do" class="lf">去购物>></a>
        </div>
...
<script>
    ...
    /* $("#go-buy").click(function(){
        window.location.href="../order/showOrder.do";
    }) */
</script>
</body>
</html>