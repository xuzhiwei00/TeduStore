...
<div id="container" class="clear">
    ...
    <div class="adress_choice">
        ...
        <div id="addresId2" class="base">
            ...
            <i class="user_address">
                ${address.recvDistric} ${address.recvAddress} ${address.recvPhone}
            </i>
    ...
    <form name="" method="post" action="#">
        <div class="product_confirm">
            ...
            <c:forEach items="${orderList}" var="cartvo">
            <ul class="item_detail">
                <li class="p_info">
                    <b><img width="84px" 
                        height="84px" src="..${cartvo.image}"/></b>
                ...
                <li class="p_price">
                    <i>达内专属价</i>
                    <br/>
                    <span class="pro_price">￥<span class="ppp_price">${cartvo.price}</span></span>
                </li>
    ...
    <!-- 结算条-->
    <div id="count_bar">
        <span class="go_cart"><a href="${pageContext.request.contextPath}/cart/showCart.do" >&lt;&lt;返回购物车</a></span>
...
<script>
    $(".go_pay").click(function () {
        ...
        location.href = "${pageContext.request.contextPath}/order/addOrder.do";
    })
</script>
<script>
