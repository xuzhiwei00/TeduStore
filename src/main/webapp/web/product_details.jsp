    ...
    <div id="tab">
        <div class="tab lf">
            <div class="cat">
                ...
                <span><a href="../web/lookforward.html">商品评价</a></span>
            </div>
        </div>
        <div class="cart rt">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#buy_now").click(function (e) {
        	...
        	console.log("nub:"+num);
        	console.log("buy："+buyAccount);
            //如果未选择，请选择商品信息
            if (color == undefined && norms == undefined) {
//            $("#add_cart").text("加入购物车").css({"background":"#f5f5f5","color":"#000"})
                alert("请选择商品信息");
            }else{
                location.href="${pageContext.request.contextPath}/order/showOrder.do";
            }
            e.preventDefault();
