				...
				<div id="wrap">
				   <c:forEach items="${goodsList}" var="goods">
					<div class="lf box" id="d1">
						<div class="info">
						<div class="img pic">
							<img src="..${goods.image}" alt="${goods.title}" onclick="toItemInfo(${goods.id},${goods.categoryId})" />
						</div>			
						<div class="describe">
							<p onclick="toItemInfo(${goods.id},${goods.categoryId})" style="width:230px;height:14px;overflow:hidden">${goods.title}</p>
...
<script type="text/javascript">
	...
	function toItemInfo(id,categoryId) {
		if (id) {
			window.location.href="../goods/goodsInfo.do?id="+id+"&categoryId="+categoryId;
		}else {
			alert("商品id不存在");
		}
	} 
